...
export default function VerifyPassword() {
  ...
  const handleOkButton = () => {
    ...
    Toast.show({
      type: 'error',
      text1: 'Pin Status',
      text2: 'We could not verify your PIN, Please try again later 👋',
      position: 'bottom',
    });
    setTimeout(() => {
      navigation.goBack();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.passwordContainer}>
        {new Array(password.length).fill(0).map((_, i) => (
          <Text style={styles.password} key={i}>
            *
          </Text>
        ))}
      </View>
      <View style={styles.buttonConatainer}>
        ...
        <RoundButton
          text={<Ionicon name="arrow-back" size={30} color="black" />}
