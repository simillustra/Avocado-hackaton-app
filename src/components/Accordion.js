...
const Accordion = ({heading, children, open = false}) => {
  ...
  }, [height, openList, rotate]);
  return (
    <View style={styles.container}>
      <Pressable style={styles.heading} onPress={() => setOpenList(!openList)}>
        <Typography text={heading} fontSize={16} bold />
