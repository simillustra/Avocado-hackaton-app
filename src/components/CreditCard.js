  ...
  return (
    <Animated.View style={[styles.container, animatedStyle]}>
      <Animated.View style={[styles.card, cardColorStyle]}>
        <Typography text={name} fontSize={20} color="whitesmoke" bold />
        <Animated.View style={[cardNumerStyle]}>
          <Typography
            text={`${number.substring(0, 2)}${'x'.repeat(number.length - 3)}${
        ...
        <View style={styles.cardFotter}>
          ...
          <Typography text={type} color="black" bold fontSize={20} />
        </View>
      </Animated.View>
    </Animated.View>
  );
